...
@section('content')
    <div class="roles">
        ...
        <div class="flex items-center justify-between mb-6">
            <div>
                <h2 class="text-white uppercase font-bold">Assign Subject</h2>
            </div>
        ...
        <div class="table w-full mt-8 bg-white rounded">
            <form action="{{ route('store.class.assign.subject',$classid) }}" method="POST" class="w-full max-w-lg px-6 py-12">
                ...
                <div class="md:flex md:items-center">
                    ...
                    <div class="md:w-2/3">
                        <button class="shadow bg-red-500 hover:bg-red-700 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded" type="submit">
                            Assign Subject
                        </button>
                    </div>
                </div>
        ...
        <div class="w-full py-12">
            <h2 class="text-white uppercase font-bold my-2">Students</h2>
