...
@section('content')
    <div class="create">
        ...
        <div class="flex items-center justify-between mb-6">
            <div>
                <h2 class="text-white uppercase font-bold">Attendance</h2>
            </div>
        ...
        <div class="w-full mt-8 bg-white rounded">
            <form action="{{ route('attendance.index') }}" method="GET" class="md:flex md:items-center md:justify-between px-6 py-6 pb-0">
                ...
                <div class="md:flex md:items-center mb-6 text-gray-700 uppercase font-bold">
                    <button class="shadow bg-red-500 hover:bg-red-700 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded" type="submit">Generate</button>
                </div>
            </form>
