...
@section('content')
    <div class="profile">
        <div class="sm:flex sm:items-center sm:justify-between mb-6">
            <div>
                <h2 class="text-white uppercase font-bold">Profile</h2>
            </div>
        ...
        <div class="mt-8 bg-white rounded">
            <form action="{{ route('profile.changepassword') }}" method="POST" class="w-full max-w-2xl px-6 py-12">
                ...
                <div class="md:flex md:items-center">
                    ...
                    <div class="md:w-2/3">
                        <button class="w-full shadow bg-red-500 hover:bg-red-700 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded" type="submit">
                            Change Password
                        </button>
                    </div>
                </div> 
